...
_PDF_NO_TITLE_ANCHOR_LAYOUTS: dict[str, str] = {
    ...
    # formats so any pairing can be tested. They are carried for the dollar-amount
    # cross-check (which reads PDF text and needs no anchors) and for the enacted text
    # itself, not for structure: they contribute no anchors for the same #141 reason as

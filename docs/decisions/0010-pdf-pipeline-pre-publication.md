...
- The "prefer XML" half is expressed as **static guidance, not active detection.**
  ...
  [0005](0005-deltatrack-boundary.md) puts outside DeltaTrack's scope: auto-detecting
  availability and switching sources belongs to a consuming tool, and is deliberately
